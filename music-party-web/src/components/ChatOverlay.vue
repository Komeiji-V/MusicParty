      ...
      >
        ...
        <div class="flex border-b border-medical-200 bg-medical-50/50">
          <button
              ...
              :key="tab"
              @click="activeTab = tab"
              class="flex-1 py-2 text-xs font-bold font-mono transition-colors relative"
        ...
        >
          ...
          <div v-if="processedMessages.length === 0" class="text-center py-8 text-xs text-medical-300 font-mono">
          ...
          >
            ...
            <div v-if="item.showTime" class="flex justify-center mb-3">
              <span class="text-[11px] font-mono text-medical-300 bg-medical-100/50 px-2 py-0.5 rounded-sm">
            ...
            >
              <div class="flex items-center gap-2 text-xs text-medical-400 mb-0.5 font-sans">
            ...
            >
              ...
              <span class="font-sans text-xs leading-relaxed break-all select-text cursor-text">
                {{ item.msg.content }}
              </span>
            </div>
            ...
            >
              <div class="bg-accent/5 border border-accent/20 text-accent px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-sm">
            ...
            >
               <div class="bg-medical-100/80 border border-medical-300 text-medical-600 px-3 py-1 rounded-md text-xs font-mono flex items-center gap-2 shadow-sm">
        ...
        <div v-else class="h-6 bg-medical-50 border-t border-medical-200 flex items-center justify-center">
          <span class="text-[11px] font-mono text-medical-300">SYSTEM LOG READ-ONLY</span>
        </div>
      </div>
    </Transition>
