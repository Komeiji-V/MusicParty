<template>
  <div id="tutorial-queue" class="h-full flex flex-col bg-white border-l border-medical-200">
    <div class="p-4 bg-medical-50 border-b border-medical-200 flex justify-between items-center">
      ...
      <!-- 清空我的点播（原 //clear 命令的可视化） -->
      <button
        v-if="queue.length > 0"
        @click="clearMine"
        title="清空自己点播的歌曲"
        class="text-xs font-mono text-medical-400 hover:text-red-500 transition-colors"
      >[清空我的点播]</button>
    </div>
          ...
          >
            <div class="flex items-center gap-3">
              <div class="text-left">
                ...
                <div class="text-xs text-medical-400 font-mono">
