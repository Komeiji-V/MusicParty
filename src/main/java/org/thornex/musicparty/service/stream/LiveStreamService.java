...
public class LiveStreamService {
    ...
    /** 流客户端是否仍然活跃（供流端点轮询判断连接是否已断开） */
    public boolean isClientActive(OutputStream outputStream) {
        return broadcaster.isClientActive(outputStream);
    }
    ...
    private synchronized void startTranscodingIfNotRunning() {
        ...
        try {
            ...
            command.add(appProperties.getMusicApi().getFfmpegPath());
